...
@Component({
  selector: 'app-grid3-view',
  templateUrl: './grid3-view.component.html',
  styleUrls: ['./grid3-view.component.css']
})
export class Grid3ViewComponent implements OnInit,OnDestroy {
